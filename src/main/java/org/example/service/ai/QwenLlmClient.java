...
public class QwenLlmClient implements LlmClient {
    ...
    public LlmGenerationResult generateCommentResult(String modelInput, CommentDetailLevel detailLevel) {
        ...
        if (baseUrl == null || baseUrl.isBlank()) {
            return fallbackWithReason(modelInput, safeDetailLevel, "未配置 qwen.base-url");
        }
        if (model == null || model.isBlank()) {
            return fallbackWithReason(modelInput, safeDetailLevel, "未配置 qwen.model");
        }
